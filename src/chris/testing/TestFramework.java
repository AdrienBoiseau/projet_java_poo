...
public class TestFramework {
    ...
    static private void print_test_result(Boolean result) {
        if (result)
    ...
    public static void run_schedule_constraints_test(ScheduleConstraintTestCase
                                                             test) {
    ...
    public static void run_activity_test(ActivityTestCase test) {
        boolean constraints_met = test.run_test_case();
        if (constraints_met)
    ...
    public static void run_constraint_test(ConstraintTestCase test) {
        boolean constraints_met = test.run_test_case();
        if (constraints_met)
